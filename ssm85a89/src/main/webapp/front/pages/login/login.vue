<template>
	<view class="content">
		<view class="logo">
			<image :style='{"boxShadow":"0 0 0px #59f43e","borderColor":"rgba(162, 117, 0, 1)","borderRadius":"30% 30% 0 0 ","borderWidth":"6rpx","width":"128rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210310/af98295bad1d47a5a76505224f8f6f17.jpg","isShow":true,"height":"128rpx"}' src='http://codegen.caihongy.cn/20210310/af98295bad1d47a5a76505224f8f6f17.jpg' mode="aspectFill"></image>
		</view>
		...
		<view class="links">
            			            <view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"color":"rgba(255, 255, 255, 1)","fontSize":"24rpx"}'>注册用户</view>
            <view>|</view>
...
<style lang="scss" scoped>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20210319/69b2697398274cc1a28aa46f5f0fc416.jpg);
