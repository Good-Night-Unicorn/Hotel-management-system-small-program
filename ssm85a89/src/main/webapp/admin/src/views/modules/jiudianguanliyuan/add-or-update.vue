<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理员姓名" prop="guanliyuanxingming">
          <el-input v-model="ruleForm.guanliyuanxingming" 
              placeholder="管理员姓名" clearable  :readonly="ro.guanliyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理员姓名" prop="guanliyuanxingming">
              <el-input v-model="ruleForm.guanliyuanxingming" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiudianguanliyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiudianguanliyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
