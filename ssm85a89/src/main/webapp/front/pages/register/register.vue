<template>
	<view class="content">
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.yonghuming" type="text" class="uni-input" name="" placeholder="用户名" />
		</view>
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='jiudianguanliyuan'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='jiudianguanliyuan'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.guanliyuanxingming" type="text" class="uni-input" name="" placeholder="管理员姓名" />
		</view>
		<view v-if="tableName=='jiudianguanliyuan'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.shouji" type="text" class="uni-input" name="" placeholder="手机" />
		</view>
