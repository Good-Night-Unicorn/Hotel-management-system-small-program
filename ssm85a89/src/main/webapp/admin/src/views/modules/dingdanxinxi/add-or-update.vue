<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预订天数" prop="yudingtianshu">
          <el-input v-model="ruleForm.yudingtianshu" 
              placeholder="预订天数" clearable  :readonly="ro.yudingtianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预订天数" prop="yudingtianshu">
              <el-input v-model="ruleForm.yudingtianshu" 
                placeholder="预订天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="预订日期" prop="yudingriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yudingriqi" label="预订日期" prop="yudingriqi">
              <el-input v-model="ruleForm.yudingriqi" 
                placeholder="预订日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.yudingriqi = this.getCurDateTime()
