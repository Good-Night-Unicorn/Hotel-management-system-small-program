    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房间详情" prop="fangjianxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangjianxiangqing" label="房间详情" prop="fangjianxiangqing">
                    <span v-html="ruleForm.fangjianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangtaiOptions = "未预约,已预约".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.fangjianxiangqing = this.ruleForm.fangjianxiangqing.replace(reg,'../../../ssm85a89/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
