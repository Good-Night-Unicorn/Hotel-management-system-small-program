<template>
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">酒店管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiudianguanliyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='jiudianguanliyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiudianguanliyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudianguanliyuan'" class="input-group">
			   <div class="label">管理员姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guanliyuanxingming" class="input" type="text" placeholder="管理员姓名">
			   </div>
			 </div> -->
			<el-form-item label="管理员姓名" class="input" v-if="tableName=='jiudianguanliyuan'">
			  <el-input v-model="ruleForm.guanliyuanxingming" autocomplete="off" placeholder="管理员姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudianguanliyuan'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jiudianguanliyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudianguanliyuan'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jiudianguanliyuan'">
