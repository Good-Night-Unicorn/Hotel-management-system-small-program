...
public class JiudianguanliyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiudianguanliyuanEntity user = jiudianguanliyuanService.selectOne(new EntityWrapper<JiudianguanliyuanEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"jiudianguanliyuan",  "酒店管理员" );
    ...
    public R register(@RequestBody JiudianguanliyuanEntity jiudianguanliyuan){
    	...
    	JiudianguanliyuanEntity user = jiudianguanliyuanService.selectOne(new EntityWrapper<JiudianguanliyuanEntity>().eq("zhanghao", jiudianguanliyuan.getZhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        JiudianguanliyuanEntity user = jiudianguanliyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        jiudianguanliyuanService.updateById(user);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JiudianguanliyuanEntity> wrapper = new EntityWrapper<JiudianguanliyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jiudianguanliyuanService.selectCount(wrapper);
